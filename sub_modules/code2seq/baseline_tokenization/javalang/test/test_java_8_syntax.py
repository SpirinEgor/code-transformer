...
class LambdaSupportTest(unittest.TestCase):
    ...
    def test_lambda_support_no_parameters_no_body(self):
        ...
        self.assert_contains_lambda_expression_in_m(parse.parse(setup_java_class("() -> {};")))
    ...
    def test_parameters_with_no_type_expression_body(self):
        ...
        """
        self.assert_contains_lambda_expression_in_m(parse.parse(setup_java_class("(x, y) -> x + y;")))
...
class MethodReferenceSyntaxTest(unittest.TestCase):
    ...
    def assert_contains_method_reference_expression_in_m(self, clazz, method_name="main"):
    ...
    def test_method_reference(self):
        ...
        self.assert_contains_method_reference_expression_in_m(parse.parse(setup_java_class("String::length;")))

    def test_method_reference_to_the_new_method(self):
        """test support for method references to 'new'."""
        self.assert_contains_method_reference_expression_in_m(parse.parse(setup_java_class("String::new;")))

    def test_method_reference_to_the_new_method_with_explict_type(self):
        """test support for method references to 'new' with an
        explicit type.
        """
        self.assert_contains_method_reference_expression_in_m(parse.parse(setup_java_class("String::<String> new;")))

    def test_method_reference_from_super(self):
        """test support for method references from 'super'."""
        self.assert_contains_method_reference_expression_in_m(parse.parse(setup_java_class("super::toString;")))

    def test_method_reference_from_super_with_identifier(self):
        """test support for method references from Identifier.super."""
        self.assert_contains_method_reference_expression_in_m(parse.parse(setup_java_class("String.super::toString;")))
    ...
    def test_method_reference_explicit_type_arguments_for_generic_type(self):
        ...
        """
        self.assert_contains_method_reference_expression_in_m(parse.parse(setup_java_class("List<String>::size;")))

    def test_method_reference_explicit_type_arguments(self):
        """test support for method references with an explicit type."""
        self.assert_contains_method_reference_expression_in_m(parse.parse(setup_java_class("Arrays::<String> sort;")))
    ...
    def test_method_reference_from_array_type(self):
        ...
        from a primary type.
        """
        self.assert_contains_method_reference_expression_in_m(parse.parse(setup_java_class("int[]::new;")))
