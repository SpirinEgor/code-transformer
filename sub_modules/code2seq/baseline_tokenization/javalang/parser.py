...
class Parser(object):
    ...
    def parse_normal_class_declaration(self):
        ...
        return tree.ClassDeclaration(
            name=name, type_parameters=type_params, extends=extends, implements=implements, body=body
        )
    ...
    def parse_field_declarators_rest(self):
        ...
        declarators = [tree.VariableDeclarator(dimensions=array_dimension, initializer=initializer)]
    ...
    def parse_interface_method_declarator_rest(self):
        ...
        return tree.MethodDeclaration(
            parameters=parameters, throws=throws, body=body, return_type=tree.Type(dimensions=array_dimension)
        )
    ...
    def parse_formal_parameters(self):
        ...
        while True:
            ...
            parameter = tree.FormalParameter(
                modifiers=modifiers, annotations=annotations, type=parameter_type, name=parameter_name, varargs=varargs
            )
    ...
    def parse_variable_declarator(self):
        ...
        return tree.VariableDeclarator(name=identifier, dimensions=array_dimension, initializer=initializer)
    ...
    def parse_local_variable_declaration_statement(self):
        ...
        var = tree.LocalVariableDeclaration(
            modifiers=modifiers, annotations=annotations, type=java_type, declarators=declarators
        )
        return var
    ...
    def parse_statement(self):
        ...
        if self.would_accept("{"):
            ...
            return tree.IfStatement(condition=condition, then_statement=then, else_statement=else_statement)
            ...
            return tree.SwitchStatement(expression=switch_expression, cases=switch_block)
            ...
            return tree.TryStatement(
                resources=resource_specification, block=block, catches=catches, finally_block=finally_block
            )
    ...
    def parse_resource(self):
        ...
        return tree.TryResource(
            modifiers=modifiers, annotations=annotations, type=reference_type, name=name, value=value
        )
    ...
    def parse_expressionl(self):
        ...
        if self.try_accept("?"):
            ...
            return tree.TernaryExpression(condition=expression_2, if_true=true_expression, if_false=false_expression)
        if self.would_accept("->"):
        ...
        if self.try_accept("::"):
            ...
            return tree.MethodReference(expression=expression_2, method=method_reference, type_arguments=type_arguments)
        return expression_2
    ...
    def parse_creator(self):
        ...
        if self.would_accept("["):
            ...
            return tree.ClassCreator(
                constructor_type_arguments=constructor_type_arguments, type=created_name, arguments=arguments, body=body
            )
    ...
    def parse_enum_constant(self):
        ...
        return tree.EnumConstantDeclaration(
            annotations=annotations, name=constant_name, arguments=arguments, body=body, documentation=javadoc
        )
